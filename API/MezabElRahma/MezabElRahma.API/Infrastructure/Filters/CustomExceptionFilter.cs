...
using Exceptions = MezabElRahma.Common.CustomException;

namespace MezabElRahma.API.Infrastructure.Filters
{
    public class CustomExceptionFilter : ExceptionFilterAttribute
    {
        ...
        protected string GetResourceMessage(string key)
        {
            ...
            {
                _resourceManager = new ResourceManager("MezabElRahma.Resources.Resource", typeof(MezabElRahma.Resources.Resource).Assembly);
            }
